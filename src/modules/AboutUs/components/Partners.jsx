...
export const Partners = () => {
    return (<Container className='flex flex-col lg:flex-row'>
      <div className='flex-1 max-w-[587px]'>
        <SectionHead title='Our Partners' imgSrc=""/>
      ...
      <div className='flex-1 relative flex max-w-[480px] mt-12'>
        <SectionHead title='SwissBorg' description='XBorg is powered by SwissBorg, a Swiss crypto app revolutionizing wealth management.' imgSrc=""/>
        <img src={Images.partners.partner01} alt='' className='w-[73px] absolute right-0 top-[35px] md:w-[103px] md:top-[-25px]'/>
      </div>
    </Container>);
};
