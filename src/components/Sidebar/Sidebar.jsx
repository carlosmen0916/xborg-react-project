...
export const Sidebar = ({ app, active, total }) => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute transition-all duration-300 scale-[2] delay-[1s] ${
          loaded ? "top-[70px] left-[8px] scale-[1]" : "top-1/2 left-1/2"
        }`}
      >
        <img src={Images.logo03} alt="Lodg" />
      </div>
      <div
        ...
        {totalArray.map((item) => (
          ...
          >
            <Tippy content={`Section-${item}`} placement="right">
              ...
              >
                <div
                  className={`w-0.5 h-0.5 border-2 ease-in duration-200 transition-all rounded-xl ${
                    active === item
